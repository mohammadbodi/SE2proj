...
import 'level2_model.dart';
export 'level2_model.dart';
...
class _Level2WidgetState extends State<Level2Widget>
    with TickerProviderStateMixin {
  late Level2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Level2Model());
